...
class MediaCache:
    ...
    def build_index(self, compute_hashes: bool = True) -> Dict[str, Dict]:
        ...
        for archive_dir_name in self.archive_dirs:
            ...
            fetch_dirs = [d for d in archive_path.iterdir() if d.is_dir() and d.name.startswith("fetched_at_")]
        ...
        self.log(f"  Index built: {self.stats['files_indexed']} files, "
    ...
    def copy_from_cache(self, media_id: str, target_path: Path, 
