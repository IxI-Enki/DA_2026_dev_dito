...
class WikiAPIClient:
    ...
    def get_all_pages(self, namespace: str = "", depth: int = 0, include_hash: bool = True) -> list:
        ...
        response = self.call("core.listPages", {
            "namespace": namespace,
            "depth": depth,
            "hash": include_hash
        })
    ...
    def get_page_info(self, page_id: str, include_author: bool = True, include_hash: bool = True) -> Dict:
        """
        ...
        """
        response = self.call("core.getPageInfo", {
            "page": page_id,
    ...
    def get_page_history(self, page_id: str, first: int = 0) -> list:
        ...
        """
        try:
            response = self.call("core.getPageHistory", {
                "page": page_id,
                "first": first
            })
            return response.get("result", [])
    ...
    def get_all_media(self, namespace: str = "", pattern: str = "", depth: int = 0,
        ...
        """
        try:
            response = self.call("core.listMedia", {
                "namespace": namespace,
                "pattern": pattern,
                "depth": depth,
                "hash": include_hash,
    ...
    def get_media_info(self, media_id: str, revision: int = 0,
        ...
        """
        try:
            response = self.call("core.getMediaInfo", {
                "media": media_id,
                "rev": revision,
                "author": include_author,
                "hash": include_hash
    ...
    def get_media_history(self, media_id: str, first: int = 0) -> list:
        ...
        """
        try:
            response = self.call("core.getMediaHistory", {
                "media": media_id,
                "first": first
            })
            return response.get("result", [])
