...
class ChangeSummary:
    ...
    def get_pages_to_fetch(self) -> List[str]:
        ...
        return [
            c.page_id for c in self.page_changes
    ...
    def get_media_to_fetch(self) -> List[str]:
        ...
        return [
            c.media_id for c in self.media_changes
            if c.change_type in (ChangeType.ADDED, ChangeType.MODIFIED)
        ]
...
class ChangeDetector:
    ...
    def fetch_wiki_page_list(self) -> Dict[str, Dict[str, Any]]:
        ...
        pages_without_revision = [
            pid for pid, info in pages.items()
    ...
    def fetch_wiki_media_list(self, namespaces: Optional[List[str]] = None) -> Dict[str, Dict[str, Any]]:
        """
