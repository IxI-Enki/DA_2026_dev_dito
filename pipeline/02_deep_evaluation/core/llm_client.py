...
class LLMClient:
    ...
    def __init__(self, config: Optional[Any] = None):
        ...
        if not self.classification_model:
            raise ValueError("LLM classification_model missing in env.yaml (LLM.classification_model)")
        ...
        self.default_system_prompt = self.llm_cfg.get('system_prompt', "Du bist ein hilfreicher Assistent.")
